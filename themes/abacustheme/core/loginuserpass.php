...
?>
	...
	<table>
		<tr>
			<td rowspan="3" width="80px"><img src="/<?php echo $this->data['baseurlpath']; ?>resources/icons/experience/gtk-dialog-authentication.48x48.png" alt="" /></td>
			<td width="120px"><?php echo $this->t('{login:username}'); ?></td>
			<td>
<?php
if ($this->data['forceUsername']) {
	echo '<strong style="padding: .6em;font-size: small">' . htmlspecialchars($this->data['username']) . '</strong>';
} else {
...
?>
		...
		<tr>
			<td ><?php echo $this->t('{login:password}'); ?></td>
